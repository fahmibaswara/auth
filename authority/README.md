...
Authority could use with [Auth](http://github.com/fahmibaswara/auth) to get current user, handle sessions, you could use it, or implement your own [AuthInterface](http://godoc.org/github.com/fahmibaswara/auth/authority#AuthInterface)

```go
import (
  "github.com/fahmibaswara/auth"
  "github.com/fahmibaswara/auth/authority"
...
Authority provides some [Rules](http://godoc.org/github.com/fahmibaswara/auth/authority#Rule) to make you define them easily, used like:
